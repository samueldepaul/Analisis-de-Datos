...
spider_transpose$Disease = c("park", "rbd", "control")
...
sp_PD1 <- ggradar(plotdata3[1,0:13], 
        grid.label.size = 4,
        axis.label.size = 4, 
        group.point.size = 2,
        group.line.width = 1,
        legend.text.size= 4) +
  labs(title = "Pacientes con Parkinson")

sp_RBD1 <- ggradar(plotdata3[2,0:13], 
        grid.label.size = 4,
        axis.label.size = 4, 
        group.point.size = 5,
        group.line.width = 1.5,
        legend.text.size= 10) +
  labs(title = "Pacientes con Trastorno del Sueño REM")

sp_HC1 <- ggradar(plotdata3[3,0:13], 
        grid.label.size = 4,
        axis.label.size = 4, 
        group.point.size = 5,
        group.line.width = 1.5,
        legend.text.size= 10) +
  labs(title = "Pacientes sanos")

sp_PD1 + sp_RBD1 +sp_HC1
```

```{r, echo = FALSE, fig.align = "center", message = FALSE, warning=FALSE}
sp_PD2 <- ggradar(plotdata3[1,14:25], 
        grid.label.size = 4,
        axis.label.size = 4, 
        group.point.size = 5,
        group.line.width = 1.5,
...
sp_RBD2 <- ggradar(plotdata3[2,14:25], 
        grid.label.size = 4,
        axis.label.size = 4, 
        group.point.size = 5,
        group.line.width = 1.5,
        legend.text.size= 10) +
  labs(title = "Pacientes con Trastorno del Sueño REM (Monólogo)")

sp_HC2 <- ggradar(plotdata3[3,14:25], 
        grid.label.size = 4,
        axis.label.size = 4, 
        group.point.size = 5,
        group.line.width = 1.5,
        legend.text.size= 10) +
  labs(title = "Pacientes sanos (Monólogo)")

sp_PD2 + sp_RBD2 +sp_HC2


#quiero hacer un diagrama de araña pero de momento no me saleeee
```
