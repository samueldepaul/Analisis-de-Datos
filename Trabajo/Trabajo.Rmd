...
```{r image_grobs2, fig.show = "hold", out.width = "35%", fig.align = "center", fig.cap="\\label{fig:figs}Resumen de las variables utilizadas",echo=FALSE}
Captura <- image_read("Captura.PNG")
Captura <- image_border(Captura, "white", "100x20")
