...
spider_wide <-lapply(spider_wide ,as.numeric)
spider_wide <- cbind(c("PD", "RBD", "HC"), spider_wide)
names(spider_wide) = c("Disease","EST", "RST", "AST", "DPI", "DVI", "GVI", "DUS", "DUF", "RLR", "PIR", "RSR", "LSE", "EST-M", "RST-M", "AST-M", "DPI-M", "DVI-M", "GVI-M", "DUS-M", "DUF-M", "RLR-M", "PIR-M", "RSR-M", "LSE-M")

plotdata <- spider_wide %>%
