...
```{r image_grobs, fig.show = "hold", out.width = "40%", fig.align = "center", fig.cap="\\label{fig:figs}Test de la espiral en pacientes sanos (izquierda) y pacientes con Parkinson (derecha)",echo=FALSE}
