...
```{r, echo = FALSE, message = FALSE, warning=FALSE,fig.show = "hold", fig.height = 7, fig.align = "center", fig.show='hide'}
...
```{r, echo = FALSE, message = FALSE, warning=FALSE, fig.show = "hold", fig.height = 7, fig.align = "center", }
plotdata3[,c(1,14:25)] %>%
  ggradar(base.size = 8,
        grid.label.size = 4,
        axis.label.size = 4, 
